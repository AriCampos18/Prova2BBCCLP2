...
import { buscarMensagem, apagarMensagem } from "../../../redux/mensagemReducer";
import { useEffect } from "react";

import ESTADO from "../../../redux/estado.js";

export default function AmostragemMensagens(props) {

    const {estado, mensagem, listaDeMensagens} = useSelector(state => state.mensagem);
    const despachante = useDispatch(); 

    useEffect(()=>{
        despachante(buscarMensagem());
    },[despachante]); 
                                ...
                                listaDeMensagens?.map((mensagem) => {
                                    return (
                                            ...
                                            <ListGroup.Item>
                                                {mensagem.urlAvatar}
                                                {mensagem.mensagem}
                                            {new Date(mensagem.dataHora).toLocaleDateString()}
